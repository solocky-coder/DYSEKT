...
void DysektProcessor::processBlock (juce::AudioBuffer& buffer,
 juce::MidiBuffer& midi)
{
 ...
 {
 std::unique_ptr decoded (rawDecoded);
 ...
 {
 std::unique_ptr sfzOwner (sfzPayload);
 ...
 {
 std::unique_ptr failed (rawFailure);
...
{
 return static_cast (new DysektProcessor());
}
