...
void WaveformView::drawSlices (juce::Graphics& g)
{
    ...
    for (int i = 0; i < num; ++i)
    {
        ...
        g.fillRect(x1, 0, 4, getHeight()); // 4-px bar. Adjust width for visibility.
        ...
        // Bold colored vertical start marker (bar also does this, leaving as reinforcing)
