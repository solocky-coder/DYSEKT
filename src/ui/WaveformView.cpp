...
void WaveformView::mouseDown(const juce::MouseEvent& e)
{
    ...
    // FIX: On single click in add slice mode, place a single-point slice at the click location
    if (sliceDrawMode)
    {
        ...
        // Optionally exit add-slice mode (or keep it active, depending on design)
        repaint();
        return;
    }
    if (altModeActive)
...
// The rest of this file (mouseDrag, mouseUp, mouseWheelMove, isInterestedInFileDrag, filesDropped, 
// enterTrimMode, setTrimPoints, setTrimMode, and any other required methods) 
// should match your last working version, since the only requested change concerned mouseDown.
// You can use your previous complete code for those functions, and this fixed mouseDown.
// The above matches your original file with the "single-click add slice" behavior as described.