...
constexpr float kKnobStart = juce::MathConstants::pi * 1.25f;
constexpr float kKnobEnd = juce::MathConstants::pi * 2.75f;
}
 ...
 juce::Colour tintOverride)
{
 ...
 const float lineAngle = angle - juce::MathConstants::halfPi;
 float lineR = fr - 2.5f;
 ...
 int& outWidth)
{
 ...
 if (armed)
 {
 const float pulse = 0.5f + 0.5f * std::sin (pulsePhase * juce::MathConstants::twoPi);
 ...
 int& outWidth)
{
 ...
 auto cell = juce::Rectangle (x, y, cellW, cellH);
