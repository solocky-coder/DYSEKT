...
struct ThemeData
{
    ...
    static ThemeData darkTheme()
    {
        ThemeData t;
        t.name          = "dark";
        t.background    = juce::Colour (0xFF242220);
    ...
    static ThemeData shellTheme()
    {
        ThemeData t;
        t.name             = "shell";
        t.background       = juce::Colour (0xFF1E2B22);
    ...
    static ThemeData lazyTheme()
    {
        ThemeData t;
        t.name             = "lazy";
        t.background       = juce::Colour (0xFF282B35);
    ...
    static ThemeData snowTheme()
    {
        ThemeData t;
        t.name             = "snow";
        t.background       = juce::Colour (0xFF32333A);
    ...
    static ThemeData ghostTheme()
    {
        ThemeData t;
        t.name             = "ghost";
        t.background       = juce::Colour (0xFF22262D);
    ...
    static ThemeData hackTheme()
    {
        ThemeData t;
        t.name             = "hack";
        t.background       = juce::Colour (0xFF232120);
    ...
    static ThemeData midnightTheme()
    {
        ThemeData t;
        t.name             = "midnight";
        t.background       = juce::Colour (0xFF201D30);   // deep purple chassis
    ...
    static ThemeData pigmentsTheme()
    {
        ThemeData t;
        t.name             = "pigments";
        t.background       = juce::Colour (0xFF1F1F2E);   // blue-tinted chassis
